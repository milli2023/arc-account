...
payload map ( payload01 , indexOfPayload01 ) -> {
	...
	Credit_Limit__c : Mule::p('organization.' ++ (sourceSystem default '') ++ '.credit_limit'), 
	Preferred_Payment_type__c: payload01.preferredPaymentType default Mule::p('default.preferred.payment.type'),
	...
	Inherit_Parent_Terms__c: if(isBlank(payload01.parentAccountId)) false else true,
	Invoice_Justification__c: "System Limit",
	System_Limit_Type__c: "Hidden Pricing",
	Payment_Status__c: "Granted",
